...
<!-- Mirrored from demo.foxthemes.net/courseplusv3.3/default/blog-card.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 10 Oct 2020 15:58:55 GMT -->
<head>
            ...
            <div class="page-content-inner">
                ...
                <div class="section-header">
                    ...
                    <div class="section-header-right">
                        <div class="display-as">
                            <a href="#" class="active"><i class="icon-feather-grid"></i></a>
                            <a href="blog-1.html"><i class="icon-feather-list"></i></a>
                ...
                <div class="uk-child-width-1-2@ uk-child-width-1-3@m" uk-grid>
                    <div>
                        ...
                        <!-- Blog Post -->
                        <a href="blog-single-1.html" class="blog-post blog-post-card">
                            <!-- Blog Post Thumbnail -->
