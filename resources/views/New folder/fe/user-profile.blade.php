...
<!-- Mirrored from demo.foxthemes.net/courseplusv3.3/default/user-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 10 Oct 2020 15:58:56 GMT -->
<head>
                ...
                <div uk-grid>
                    ...
                    <div class="uk-width-expand@m">
                        ...
                        <div class="uk-card-default rounded mt-4">
                            ...
                            <div class="uk-child-width-1-2@s uk-grid-small p-4" uk-grid>
                                <div>
                                    <h6 class="uk-text-bold"> Number </h5>
                                        <p> 23, Block C2 </p>
                                </div>
                                <div>
                                    <h6 class="uk-text-bold"> Street </h5>
                                        <p> Church Street </p>
                                </div>
                                <div>
                                    <h6 class="uk-text-bold"> City </h5>
                                        <p> Los Angeles </p>
                                </div>
                                <div>
                                    <h6 class="uk-text-bold"> Postal Code </h5>
                                        <p> 100065 </p>
                                </div>
                                <div>
                                    <h6 class="uk-text-bold"> State </h5>
                                        <p> CA </p>
                                </div>
                                <div>
...
<!-- Mirrored from demo.foxthemes.net/courseplusv3.3/default/user-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 10 Oct 2020 15:58:57 GMT -->
</html>