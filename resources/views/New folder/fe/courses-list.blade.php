...
<!-- Mirrored from demo.foxthemes.net/courseplusv3.3/default/courses-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 10 Oct 2020 15:57:07 GMT -->
<head>
    ...
    <div id="wrapper">
        ...
        <div class="page-content">
            ...
            <div class="container">
                ...
                <h4> Browse Web Development <a href="#" class="text-muted">Courses</a> </h4>
                        ...
                        <div class="course-card course-card-list">
                            ...
                            <div class="course-card-body">
                                ...
                                <p>Kick your Angular skills into action with this comprehensive dive into Angular and
                                    getting
                                    started the right way. Complete with best practices and architecture practices.</p>
                                <div class="course-details-info">
                                    <ul>
                        ...
                        <div class="course-card course-card-list">
                            ...
                            <div class="course-card-body">
                                ...
                                <p>JavaScript is how you build interactivity on the web. Take this course to learn how
                                    to work
                                    with the DOM, create Objects, make AJAX calls, and much more!</p>
                                <div class="course-details-info">
                                    <ul>
                                        <li> <i class="icon-feather-sliders"></i> Advance level </li>
