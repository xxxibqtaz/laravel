...
<div id="wrapper">
                ...
                <div class="uk-navbar-right">
                    ...
                    <div class="header-widget">
                            ...
                            <div class="dropdown-notifications-content" data-simplebar>
                                ...
                                <ul>
                                    <li class="notifications-not-read">
                                        <a href="course-intro">
                                                <span class="notification-image">
                                                    <img src="{{asset('frontend/images/course/1.png')}}" alt=""> </span>
                                    ...
                                    <li>
                                        <a href="course-intro">
                                                <span class="notification-image">
                                                    <img src="{{asset('frontend/images/course/3.png')}}" alt=""> </span>
                                            <span class="notification-text">
                                    ...
                                    <li>
                                        <a href="course-intro">
                                                <span class="notification-image">
                                                    <img src="{{asset('frontend/images/course/2.png')}}" alt=""> </span>
                                            <span class="notification-text">
                                    ...
                                    <li>
                                        <a href="course-intro">
                                                <span class="notification-image">
                                                    <img src="{{URL::to('/public/frontend/images/course/1.png')}} "alt=""> </span>
                                            <span class="notification-text">
                                                    <span class="course-title">Ultimate Web Designer & Web Developer
                                                    </span>
                                                    <span class="course-number">6/35 </span>
                            ...
                            <div class="dropdown-notifications-content" data-simplebar>
                                ...
                                <ul>
                                    <li class="notifications-not-read">
                                        <a href="#">
                                                <span class="notification-avatar">
                                                    <img src="{{asset('frontend/images/avatars/avatar-2.jpg')}}" alt="">
                                                </span>
                                    ...
                                    <li>
                                        <a href="#">
                                                <span class="notification-avatar">
                                                    <img src="{{asset('frontend/images/avatars/avatar-4.jpg')}}" alt="">
                                                </span>
                                            <div class="notification-text notification-msg-text">
                        ...
                        <a href="#" class="header-widget-icon profile-icon">
                            <img src="{{asset('frontend/images/avatars/avatar-2.jpg')}}" alt="" class="header-profile-icon">
                        </a>
    ...
    <div class="side-nav uk-animation-slide-left-medium">
        ...
        <ul>
            <li>
                <a href="{{URL::to('courses')}}"> <i class="uil-play-circle"></i> </a>
                <div class="side-menu-slide">
                    <div class="side-menu-slide-content">
                        <ul data-simplebar>
                            @foreach($category as $item)
                                <li>
                                    <a href="{{URL::to('courses/'.$item->id)}}"> <i class="uil-brush-alt "></i> {{$item->name}} </a>
                                </li>
                        @endforeach
