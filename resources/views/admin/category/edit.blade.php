                    ...
                    <div class="card-body">
                        ...
                        <form class="m-t-40" novalidate method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="name" class="form-control" required data-validation-required-message="This field is required" value="{{$category->name}}"> </div>

                            </div>
                            <div class="form-group">
                                <h5>Hình ảnh<span class="text-danger">*</span></h5>
                                <div class="controls">
                                    <input type="file" name="img" class="form-control" required value="{{$category->image}}" onchange="readURL(this);">
                                    <img src="{{asset('/upload/'.$category->image)}}" width="100px" id="blah">
                                </div>
                            </div>
