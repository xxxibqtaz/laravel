...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="{{URL::to('/backend/plugins/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
    <!-- Morries chart CSS -->
    <link href="{{URL::to('/backend/plugins/morrisjs/morris.css')}}" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="{{URL::to('/backend/css/style.css')}}" rel="stylesheet">
    <!-- You can change the theme colors from here -->
    <link href="{{URL::to('/backend/css/colors/blue.css')}}" id="theme" rel="stylesheet">
...
<body class="fix-header card-no-border logo-center">
                    ...
                    <ul id="sidebarnav">
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{URL::to('/admin/courses')}}">Tất cả khóa học</a></li>
                                <li><a href="{{URL::to('/admin/category')}}">Danh mục khóa học</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="{{URL::to('/backend/plugins/jquery/jquery.min.js')}}"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="{{URL::to('/backend/plugins/bootstrap/js/popper.min.js')}}"></script>
    <script src="{{URL::to('/backend/plugins/bootstrap/js/bootstrap.min.js')}}"></script>
    <!-- slimscrollbar scrollbar JavaScript -->
    <script src="{{URL::to('/backend/js/jquery.slimscroll.js')}}"></script>
    <!--Wave Effects -->
    <script src="{{URL::to('/backend/js/waves.js')}}"></script>
    <!--Menu sidebar -->
    <script src="{{URL::to('/backend/js/sidebarmenu.js')}}"></script>
    <!--stickey kit -->
    <script src="{{URL::to('/backend/plugins/sticky-kit-master/dist/sticky-kit.min.js')}}"></script>
    <script src="{{URL::to('/backend/plugins/sparkline/jquery.sparkline.min.js')}}"></script>
    <!--Custom JavaScript -->
    <script src="{{URL::to('/backend/js/custom.min.js')}}"></script>
    <!-- ============================================================== -->
    <!-- This page plugins -->
    <!-- ============================================================== -->
    <!--morris JavaScript -->
    <script src="{{URL::to('/backend/plugins/raphael/raphael-min.js')}}"></script>
    <script src="{{URL::to('/backend/plugins/morrisjs/morris.min.js')}}"></script>
    <!-- sparkline chart -->
    <script src="{{URL::to('/backend/plugins/sparkline/jquery.sparkline.min.js')}}"></script>
    <script src="{{URL::to('/backend/js/dashboard4.js')}}"></script>
    <!-- ============================================================== -->
    <!-- Style switcher -->
    <!-- ============================================================== -->
    <script src="{{URL::to('/backend/plugins/styleswitcher/jQuery.style.switcher.js')}}"></script>
</body>
