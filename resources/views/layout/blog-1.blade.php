...
@section('blog-1')
    ...
    <div class="uk-child-width-1-2@m uk-grid-match uk-grid-small" uk-grid>
        <div><a href="#" class="uk-flex">
                <div data-src="../public/frontend/images/blog/img-8.jpg"
            ...
            <div class="uk-child-width-1-2@m uk-grid-small uk-card-match" uk-grid>
                <div> <a href="#">
                        <div class="uk-card-default rounded uk-overflow-hidden">
                            <img src="../public/frontend/images/blog/img-1.jpg" alt="">
                            <div class="p-3">
                ...
                <div><a href="#">
                        <div class="uk-card-default rounded uk-overflow-hidden">
                            <img src="../public/frontend/images/blog/img-2.jpg" alt="" class="uk-width-1-1">
                            <div class="p-3">
                ...
                <div><a href="#">
                        <div class="uk-card-default rounded uk-overflow-hidden">
                            <img src="../public/frontend/images/blog/img-3.jpg" alt="">
                            <div class="p-3">
                ...
                <div><a href="#">
                        <div class="uk-card-default rounded uk-overflow-hidden">
                            <img src="../public/frontend/images/blog/img-4.jpg" alt="">
                            <div class="p-3">
            ...
            <a href="blog-single-1.html" class="blog-post">
                ...
                <div class="blog-post-thumbnail">
                    <div class="blog-post-thumbnail-inner">
                        ...
                        <img src="../public/frontend/images/blog/img-2.jpg" alt="">
                    </div>
                </div>
                <!-- Blog Post Content -->
                <div class="blog-post-content">
                        ...
                        <div class="py-3 px-4">
                            ...
                            <div class="uk-grid-small" uk-grid>
                                ...
                                <div class="uk-width-1-3">
                                    <img src="../public/frontend/images/blog/img-3.jpg" alt="" class="rounded-sm">
                                </div>
                            </div>
                            <div class="uk-grid-small" uk-grid>
                                <div class="uk-width-expand">
                                ...
                                <div class="uk-width-1-3">
                                    <img src="../public/frontend/images/blog/img-2.jpg" alt="" class="rounded-sm">
                                </div>
                            </div>
                            <div class="uk-grid-small" uk-grid>
                                <div class="uk-width-expand">
