                ...
                <a href="episode-details.html">
                    <div class="course-card episode-card animate-this">
                        <div class="course-card-thumbnail ">
                            ...
                            <img src="../public/frontend/images/episodes/2.png">
                ...
                <a href="episode-details.html">
                    <div class="course-card episode-card animate-this">
                        <div class="course-card-thumbnail ">
                            ...
                            <img src="../public/frontend/images/episodes/3.png">
                            <span class="play-button-trigger"></span>
                        </div>
                        <div class="course-card-body">
                ...
                <a href="episode-details.html">
                    <div class="course-card episode-card animate-this">
                        <div class="course-card-thumbnail ">
                            ...
                            <span class="duration">5:39</span>
                            <img src="../public/frontend/images/episodes/1.png">
                            <span class="play-button-trigger"></span>
                        </div>
                        <div class="course-card-body">
                ...
                <a href="episode-details.html">
                    <div class="course-card episode-card animate-this">
                        <div class="course-card-thumbnail ">
                            ...
                            <span class="duration">2:39</span>
                            <img src="../public/frontend/images/episodes/5.png">
                            <span class="play-button-trigger"></span>
                        </div>
                        <div class="course-card-body">
...
<h4> Web Development and Designing Courses </h4>
    ...
    <div class="uk-child-width-1-4@m uk-child-width-1-3@s " uk-grid>
            ...
            <a href="episode-details.html">
                <div class="course-card episode-card animate-this">
                    <div class="course-card-thumbnail ">
                        ...
                        <img src="../public/frontend/images/episodes/6.png">
                        <span class="play-button-trigger"></span>
                    </div>
                    <div class="course-card-body">
                        <h4 class="mb-0">Creating Website Pure CSS </h4>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div>
            <a href="episode-details.html">
                <div class="course-card episode-card animate-this">
                    <div class="course-card-thumbnail ">
                        <span class="item-tag">Larafel</span>
                        <span class="duration">5:39</span>
                        <img src="../public/frontend/images/episodes/4.png">
                        <span class="play-button-trigger"></span>
                    </div>
                    <div class="course-card-body">
                        <h4 class="mb-0"> Larafel $ fliepond </h4>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div>
            <a href="episode-details.html">
                <div class="course-card episode-card animate-this">
                    <div class="course-card-thumbnail ">
                        <span class="item-tag">Laravel</span>
                        <span class="duration">5:39</span>
                        <img src="../public/frontend/images/episodes/3.png">
                        <span class="play-button-trigger"></span>
                    </div>
                    <div class="course-card-body">
                        <h4 class="mb-0"> Creating a Laravel Package </h4>
                    </div>
                </div>
            </a>
        </div>
