...
<head>
    ...
    <link rel="stylesheet" href="../frontend/css/night-mode.css">
    <link rel="stylesheet" href="../frontend/css/framework.css">
                            ...
                            @foreach($lessons as $item)
                                ...
                                <li>
                                    ...
                                    <div class="video-responsive">
                                        <iframe src="{{asset($item->video)}}" frameborder="0"
                            ...
                            <li class="uk-open">
                                ...
                                <div class="uk-accordion-content">
                                    ...
                                    <ul class="course-video-list highlight-watched"
                                        ...
                                        @foreach($lessons as $item)
                                        <li class="watched"> <a href="#"> {{$item->name}} <span> 23 min </span> </a></li>
                                        @endforeach
