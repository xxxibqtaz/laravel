...
<?php $__env->startSection('courses'); ?>
        ...
        <div class="uk-child-width-1-4@m uk-child-width-1-3@s course-card-grid" uk-grid>
                ...
                <a href="course-intro">
                    <div class="course-card">
                        <div class="course-card-thumbnail ">
                            <img src="../public/frontend/images/course/2.png">
            ...
            <div>
                <a href="course-intro">
                    <div class="course-card">
                        <div class="course-card-thumbnail ">
                            <img src="../public/frontend/images/course/3.png">
                            <span class="play-button-trigger"></span>
                        </div>
                        <div class="course-card-body">
                            <div class="course-card-info">
            ...
            <div>
                <a href="course-intro">
                    <div class="course-card">
                        <div class="course-card-thumbnail ">
                            <img src="../public/frontend/images/course/1.png">
                            <span class="play-button-trigger"></span>
                        </div>
                        <div class="course-card-body">
                            <div class="course-card-info">
            ...
            <div>
                <a href="course-intro">
                    <div class="course-card">
                        <div class="course-card-thumbnail ">
                            <img src="../public/frontend/images/course/5.png">
                            <span class="play-button-trigger"></span>
                        </div>
                        <div class="course-card-body">
                            <div class="course-card-info">
    ...
    <div class="section-header pb-0 mt-5">
        <div class="section-header-left">
            <h4> Most popular <a href="courses">Courses</a> </h4>
        </div>
        <div class="section-header-right">
            ...
            <div class="display-as">
                <a href="courses-list" uk-tooltip="title: Course list; pos: top-right">
        ...
        <div class="uk-child-width-1-4@m uk-child-width-1-3@s course-card-grid uk-grid-match" uk-grid>
            ...
            <div>
                <a href="course-intro">
                    <div class="course-card">
                        <div class="course-card-thumbnail ">
                            <img src="../public/frontend/images/course/6.png">
                            <span class="play-button-trigger"></span>
                        </div>
                        <div class="course-card-body">
                            <div class="course-card-info">
            ...
            <div>
                <a href="course-intro">
                    <div class="course-card">
                        <div class="course-card-thumbnail ">
                            <img src="../public/frontend/images/course/4.png">
                            <span class="play-button-trigger"></span>
                        </div>
                        <div class="course-card-body">
                            <div class="course-card-info">
            ...
            <div>
                <a href="course-intro">
                    <div class="course-card">
                        <div class="course-card-thumbnail ">
                            <img src="../public/frontend/images/course/7.png">
                            <span class="play-button-trigger"></span>
                        </div>
                        <div class="course-card-body">
                            <div class="course-card-info">
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lms1\resources\views/layout/courses.blade.php ENDPATH**/ ?>