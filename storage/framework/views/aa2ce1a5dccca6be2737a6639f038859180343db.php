<?php $__env->startSection('dashboard'); ?>
    ...
    <div class="home-hero" data-src="<?php echo e($banner->image); ?>" uk-img>
                            ...
                            <a href="course-intro">
                                <div class="course-card">
                                    <div class="course-card-thumbnail ">
                                        <img src="<?php echo e(asset('upload/'.$item->image)); ?>">
                                        <span class="play-button-trigger"></span>
                                    </div>
                                    <div class="course-card-body">
                                        <div class="course-card-info">
                                            <div>
                                                <span class="catagory"><?php echo e($item->CataName); ?></span>
                                            </div>
                                            <div>
                                        ...
                                        <p style="overflow: hidden; max-height: 100px"><?php echo e($item->preview); ?></p>
                                        <div class="course-card-footer">
                                            <h5> <i class="icon-feather-film"></i> <?php echo e($item->total_lessons); ?> Lectures </h5>
                                            <h5> <i class="icon-feather-clock"></i> <?php echo e($item->time); ?> Hours </h5>
                                        </div>
                                    </div>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lms1\resources\views/layout/dashboard.blade.php ENDPATH**/ ?>