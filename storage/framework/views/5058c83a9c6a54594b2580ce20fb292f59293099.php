...
<head>
    ...
    <!-- Favicon -->
    <link href="<?php echo e(asset('frontend/images/favicon.png')); ?>" rel="icon" type="image/png">

    <!-- CSS
    ================================================== -->
    <link rel="stylesheet" href="<?php echo e(asset('frontend/css/style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontend/css/night-mode.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontend/css/framework.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('frontend/css/bootstrap.css')); ?>">

    <!-- icons
    ================================================== -->
    <link rel="stylesheet" href="<?php echo e(asset('frontend/css/icons.css')); ?>">
...
<div id="wrapper">
                ...
                <div class="uk-navbar-right">
                    ...
                    <div class="header-widget">
                            ...
                            <div class="dropdown-notifications-content" data-simplebar>
                                ...
                                <ul>
                                    <li class="notifications-not-read">
                                        <a href="course-intro">
                                                <span class="notification-image">
                                                    <img src="<?php echo e(asset('frontend/images/course/1.png')); ?>" alt=""> </span>
                                    ...
                                    <li>
                                        <a href="course-intro">
                                                <span class="notification-image">
                                                    <img src="<?php echo e(asset('frontend/images/course/3.png')); ?>" alt=""> </span>
                                            <span class="notification-text">
                                    ...
                                    <li>
                                        <a href="course-intro">
                                                <span class="notification-image">
                                                    <img src="<?php echo e(asset('frontend/images/course/2.png')); ?>" alt=""> </span>
                                            <span class="notification-text">
                                    ...
                                    <li>
                                        <a href="course-intro">
                                                <span class="notification-image">
                                                    <img src="<?php echo e(URL::to('/public/frontend/images/course/1.png')); ?> "alt=""> </span>
                                            <span class="notification-text">
                                                    <span class="course-title">Ultimate Web Designer & Web Developer
                                                    </span>
                                                    <span class="course-number">6/35 </span>
                            ...
                            <div class="dropdown-notifications-content" data-simplebar>
                                ...
                                <ul>
                                    <li class="notifications-not-read">
                                        <a href="#">
                                                <span class="notification-avatar">
                                                    <img src="<?php echo e(asset('frontend/images/avatars/avatar-2.jpg')); ?>" alt="">
                                                </span>
                                    ...
                                    <li>
                                        <a href="#">
                                                <span class="notification-avatar">
                                                    <img src="<?php echo e(asset('frontend/images/avatars/avatar-3.jpg')); ?>" alt="">
                                                </span>
                                            <div class="notification-text notification-msg-text">
                                    ...
                                    <li>
                                        <a href="#">
                                                <span class="notification-avatar">
                                                    <img src="<?php echo e(asset('frontend/images/avatars/avatar-1.jpg')); ?>" alt="">
                                                </span>
                                            <div class="notification-text notification-msg-text">
                                    ...
                                    <li>
                                        <a href="#">
                                                <span class="notification-avatar">
                                                    <img src="<?php echo e(asset('frontend/images/avatars/avatar-4.jpg')); ?>" alt="">
                                                </span>
                                            <div class="notification-text notification-msg-text">
                        ...
                        <a href="#" class="header-widget-icon profile-icon">
                            <img src="<?php echo e(asset('frontend/images/avatars/avatar-2.jpg')); ?>" alt="" class="header-profile-icon">
                        </a>
    ...
    <div class="side-nav uk-animation-slide-left-medium">
        ...
        <ul>
            <li>
                <a href="<?php echo e(URL::to('courses')); ?>"> <i class="uil-play-circle"></i> </a>
                <div class="side-menu-slide">
                    <div class="side-menu-slide-content">
                        <ul data-simplebar>
                            <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <a href="<?php echo e(URL::to('courses/'.$item->id)); ?>"> <i class="uil-brush-alt "></i> <?php echo e($item->name); ?> </a>
                                </li>
...
<!-- javaScripts
================================================== -->
<script src="<?php echo e(asset('frontend/js/framework.js')); ?>"></script>
<script src="<?php echo e(asset('frontend/js/jquery-3.3.1.min.js')); ?>"></script>
<script src="<?php echo e(asset('frontend/js/simplebar.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\lms1\resources\views/index.blade.php ENDPATH**/ ?>