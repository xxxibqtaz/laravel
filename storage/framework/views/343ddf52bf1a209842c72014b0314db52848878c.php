...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="../public/backend/images/favicon.png">
    ...
    <link href="../public/backend/css/colors/blue.css" id="theme" rel="stylesheet">
...
<body class="fix-header card-no-border logo-center">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon --><b>
                            ...
                            <!-- Dark Logo icon -->
                            <img src="../public/backend/images/logo-icon.png" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                            <img src="../public/backend/images/logo-light-icon.png" alt="homepage" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text --><span>
                            <!-- dark Logo text -->
                            <img src="../public/backend/images/logo-text.png" alt="homepage" class="dark-logo" />
                            <!-- Light Logo text -->
                            <img src="../public/backend/images/logo-light-text.png" class="light-logo"
                                alt="homepage" /></span> </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="../public/backend/images/users/1.jpg"
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="../public/backend/images/users/2.jpg"
                                                        alt="user" class="img-circle"> <span
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="../public/backend/images/users/3.jpg"
                                                        alt="user" class="img-circle"> <span
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="../public/backend/images/users/4.jpg"
                                                        alt="user" class="img-circle"> <span
                                            ...
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <div class="container"> <img class="d-block img-fluid"
                                                            src="../public/backend/images/big/img1.jpg"
                                                            alt="First slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid"
                                                            src="../public/backend/images/big/img2.jpg"
                                                            alt="Second slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid"
                                                            src="../public/backend/images/big/img3.jpg"
                                                            alt="Third slide"></div>
                                                </div>
                                            </div>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href=""
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                    src="../public/backend/images/users/1.jpg" alt="user" class="profile-pic" /></a>
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            <div class="u-img"><img src="../public/backend/images/users/1.jpg"
                                                    alt="user"></div>
                                            <div class="u-text">
                                                <h4>Steave Jobs</h4>
                    ...
                    <ul id="sidebarnav">
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="catalog">Danh mục khóa học</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="app-calendar.html">Chung</a></li>
                                <li><a href="app-chat.html">Banner</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
    ...
    <script src="../public/backend/plugins/bootstrap/js/popper.min.js"></script>
    <script src="../public/backend/plugins/bootstrap/js/bootstrap.min.js"></script>
    ...
    <!--stickey kit -->
    <script src="../public/backend/plugins/sticky-kit-master/dist/sticky-kit.min.js"></script>
    <script src="../public/backend/plugins/sparkline/jquery.sparkline.min.js"></script>
    <!--Custom JavaScript -->
    ...
    <script src="../public/backend/plugins/morrisjs/morris.min.js"></script>
    <!-- sparkline chart -->
    <script src="../public/backend/plugins/sparkline/jquery.sparkline.min.js"></script>
    <script src="../public/backend/js/dashboard4.js"></script>
    <!-- ============================================================== -->
    <!-- Style switcher -->
    <!-- ============================================================== -->
    <script src="../public/backend/plugins/styleswitcher/jQuery.style.switcher.js"></script>
</body>

</html>
<?php /**PATH C:\xampp\htdocs\lms\resources\views/admin.blade.php ENDPATH**/ ?>